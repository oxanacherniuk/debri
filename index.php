                ...
                <div class="main-box">
                    <div class="main-box__buttons">
                        ...
                        <div class="round-banner__button">
                            <img src="img/round_text.svg" class="round-text">
                ...
                <div class="container">
                    <div class="quiz-inner">
                        ...
                        <div class="second-step row">
                            ...
                            <img src="img/second-step_img.png" alt="Дебри">
                        </div>
            ...
            <div class="circumscribing-box">
                <div class="circumscribing-box__col">
                    ...
                    <p class="circumscribing-box__text">
                        Согласно сложившейся еще с давних времен традиции, сауна - это прекрасный способ расслабиться.
                        <br><br>
                        Оборудованная по всем правилам сауна гарантирует вам безопасный отдых, а комфортные номера - уединенность и
                        конфиденциальность. Уютная атмосфера и дружелюбный персонал окажут вам помощь в том, чтобы насладиться отдыхом в
                        одиночестве или в компании.
                        <br><br>
                        А если вы предпочитаете отдых в компании друзей или семьи, тогда мы рады предложить вам снять сауну с просторными
                        залами, способными вместить до 25 человек. В них вы найдете все необходимое для того, чтобы приятно провести время и
                ...
                <div class="reviews-inner">
                    <div class="review">
                        ...
                        <div class="review-box">
                            <img src="img/tatyana.png" alt="Фото Татьяны" class="client-img">
                    ...
                    <div class="review">
                        ...
                        <div class="review-box">
                            <img src="img/ilya.png" alt="Фото Ильи" class="client-img">
                            <div class="review-info">
                    ...
                    <div class="review">
                        ...
                        <div class="review-box">
                            ...
                            <div class="review-info">
                                <p class="client-name">Татьяна Егорова</p>
                                <p class="client-date">6 августа 2025</p>
                                <p class="client-review">Отдыхали с компанией в комплексе Дебри, очень понравилось. Были в Люксе, все на
                                    высшем уровне. Бассейн выше всяких
                                    похвал, идеальная температура, без запаха, ощущение, что в чистом теплом море плаваешь... <a href=""
                    ...
                    <div class="review">
                        ...
                        <div class="review-box">
                            ...
                            <div class="review-info">
                                <p class="client-name">Илья Ильич</p>
                                <p class="client-date">19 февраля 2025</p>
                                <p class="client-review">Банный комплекс сам по себе замечательный. Я побывал в двух помещениях. Всё чисто,
                                    аккуратно. Всё что надо для дыхание
                                    имеется и посуда и столы и кресла качалки и музыка и видео. Бассейны тоже чистые... <a href=""
                                        class="read-btn">Читать ещё</a></p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="contacts-box">
                ...
                <div class="contacts-box__col">
                    <div style="position:relative;overflow:hidden;">
                        <a
                            href="https://yandex.ru/maps/org/debri/148293410018/?utm_medium=mapframe&utm_source=maps"
                            style="color:#eee;font-size:12px;position:absolute;top:0px;">Дебри</a>
                            <a
                            href="https://yandex.ru/maps/195/ulyanovsk/category/guest_house/131994109947/?utm_medium=mapframe&utm_source=maps"
